...
.EXAMPLE
   Enable-NagiosHostNotifications -ComputerName SERVER01 -username svcnagiosadmin -password Password! -NagiosCoreUrl https://nagiosdev.domain.com/nagios
#>
Function Enable-NagiosHostNotifications {
    ...
    process {
        foreach ($Computer in $ComputerName) {
            ...
            Invoke-NagiosRequest -ComputerName $Computer -action 28 -username $username -password $password -NagiosCoreUrl $NagiosCoreUrl
            }
        }
    end {}
    }